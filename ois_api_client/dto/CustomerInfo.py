...
class CustomerInfo:
    ...
    def __init__(self, customer_tax_number: TaxNumber, group_member_tax_number: TaxNumber,
                 community_vat_number: str, third_state_tax_id: str,
                 customer_name: str, customer_address: Union[SimpleAddress, DetailedAddress],
